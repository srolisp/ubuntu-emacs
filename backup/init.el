...
(define-key term-mode-map (kbd "C-c C-j") 'srl/term-toggle-mode)
(define-key term-mode-map (kbd "C-c C-k") 'srl/term-toggle-mode)

(define-key term-raw-map (kbd "C-c C-j") 'srl/term-toggle-mode)
(define-key term-raw-map (kbd "C-c C-k") 'srl/term-toggle-mode)
